...
var app = (function () {
    ...
    const file$5 = "src\\core\\CanvasItems\\CanvasImage.svelte";
    ...
    const canvasItems = writable([
        new CanvasItem$1("asdfsjakldfldsa", { x: 0, y: 0 }, { x: 100, y: 100 }, CanvasImage),
        new CanvasItem$1("asdfsjakldflddsaf", { x: 200, y: 200 }, { x: 300, y: 300 }, CanvasImage),
        new CanvasItem$1("asdfsjakldfldsa", { x: 300, y: 0 }, { x: 100, y: 100 }, CanvasImage),
        new CanvasItem$1("asdfsjakldfldsa", { x: 400, y: 0 }, { x: 100, y: 100 }, CanvasImage),
        new CanvasItem$1("asdfsjakldfldsa", { x: 500, y: 0 }, { x: 100, y: 100 }, CanvasImage),
    ]);
    /*-----   Input System   -----*/
    let activeInput = [];
    const operations = {
    ...
    const file$4 = "src\\core\\BoxSelection.svelte";
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(filter, file$4, 96, 4, 3477);
    			add_location(defs, file$4, 95, 2, 3465);
    			...
    			add_location(rect, file$4, 101, 2, 3703);
    			...
    			add_location(svg, file$4, 86, 0, 3243);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    const file$3 = "src\\core\\Selection.svelte";
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(line, "x1", line_x__value = /*position*/ ctx[1].x);
    			attr_dev(line, "y1", line_y__value = /*position*/ ctx[1].y - 1);
    			attr_dev(line, "x2", line_x__value_1 = /*position*/ ctx[1].x + /*scale*/ ctx[2].x);
    			attr_dev(line, "y2", line_y__value_1 = /*position*/ ctx[1].y - 1);
    			add_location(line, file$3, 100, 4, 4372);
    			attr_dev(rect, "x", rect_x_value = /*position*/ ctx[1].x);
    			attr_dev(rect, "y", rect_y_value = /*position*/ ctx[1].y);
    			attr_dev(rect, "width", rect_width_value = "" + (/*scale*/ ctx[2].x + "px"));
    			attr_dev(rect, "height", rect_height_value = "" + (/*scale*/ ctx[2].y + "px"));
    			attr_dev(rect, "rx", rect_rx_value = 40 * /*$canvasCurrentScale*/ ctx[0]);
    			attr_dev(rect, "class", "svelte-1k24ufo");
    			add_location(rect, file$3, 101, 4, 4468);
    			attr_dev(circle0, "cx", circle0_cx_value = /*position*/ ctx[1].x);
    			attr_dev(circle0, "cy", circle0_cy_value = /*position*/ ctx[1].y);
    			attr_dev(circle0, "r", 8);
    			attr_dev(circle0, "class", "svelte-1k24ufo");
    			add_location(circle0, file$3, 102, 4, 4583);
    			attr_dev(circle1, "cx", circle1_cx_value = /*position*/ ctx[1].x + /*scale*/ ctx[2].x);
    			attr_dev(circle1, "cy", circle1_cy_value = /*position*/ ctx[1].y);
    			attr_dev(circle1, "r", 8);
    			attr_dev(circle1, "class", "svelte-1k24ufo");
    			add_location(circle1, file$3, 103, 4, 4699);
    			attr_dev(circle2, "cx", circle2_cx_value = /*position*/ ctx[1].x + /*scale*/ ctx[2].x);
    			attr_dev(circle2, "cy", circle2_cy_value = /*position*/ ctx[1].y + /*scale*/ ctx[2].y);
    			attr_dev(circle2, "r", 8);
    			attr_dev(circle2, "class", "svelte-1k24ufo");
    			add_location(circle2, file$3, 109, 4, 4859);
    			attr_dev(circle3, "cx", circle3_cx_value = /*position*/ ctx[1].x);
    			attr_dev(circle3, "cy", circle3_cy_value = /*position*/ ctx[1].y + /*scale*/ ctx[2].y);
    			attr_dev(circle3, "r", 8);
    			attr_dev(circle3, "class", "svelte-1k24ufo");
    			add_location(circle3, file$3, 115, 4, 5032);
    			attr_dev(svg, "class", "svelte-1k24ufo");
    			add_location(svg, file$3, 99, 2, 4361);
    			attr_dev(div, "id", "selection");
    			set_style(div, "--visibility", /*visibility*/ ctx[3]);
    			attr_dev(div, "class", "svelte-1k24ufo");
    			add_location(div, file$3, 98, 0, 4302);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					listen_dev(window, "mousemove", /*windowMouseMove*/ ctx[5], false, false, false),
    					listen_dev(window, "mouseup", /*windowMouseUp*/ ctx[6], false, false, false),
    					...
    					listen_dev(circle2, "mousedown", /*mousedown_handler_2*/ ctx[16], false, false, false),
    					listen_dev(circle3, "mousedown", /*mousedown_handler_3*/ ctx[17], false, false, false)
    				];
    		...
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*position*/ 2 && line_x__value !== (line_x__value = /*position*/ ctx[1].x)) {
    				attr_dev(line, "x1", line_x__value);
    			}

    			if (dirty & /*position*/ 2 && line_y__value !== (line_y__value = /*position*/ ctx[1].y - 1)) {
    				attr_dev(line, "y1", line_y__value);
    			}

    			if (dirty & /*position, scale*/ 6 && line_x__value_1 !== (line_x__value_1 = /*position*/ ctx[1].x + /*scale*/ ctx[2].x)) {
    				attr_dev(line, "x2", line_x__value_1);
    			}

    			if (dirty & /*position*/ 2 && line_y__value_1 !== (line_y__value_1 = /*position*/ ctx[1].y - 1)) {
    				attr_dev(line, "y2", line_y__value_1);
    			}

    			if (dirty & /*position*/ 2 && rect_x_value !== (rect_x_value = /*position*/ ctx[1].x)) {
    				attr_dev(rect, "x", rect_x_value);
    			}

    			if (dirty & /*position*/ 2 && rect_y_value !== (rect_y_value = /*position*/ ctx[1].y)) {
    				attr_dev(rect, "y", rect_y_value);
    			}

    			if (dirty & /*scale*/ 4 && rect_width_value !== (rect_width_value = "" + (/*scale*/ ctx[2].x + "px"))) {
    				attr_dev(rect, "width", rect_width_value);
    			}

    			if (dirty & /*scale*/ 4 && rect_height_value !== (rect_height_value = "" + (/*scale*/ ctx[2].y + "px"))) {
    				attr_dev(rect, "height", rect_height_value);
    			}

    			if (dirty & /*$canvasCurrentScale*/ 1 && rect_rx_value !== (rect_rx_value = 40 * /*$canvasCurrentScale*/ ctx[0])) {
    				attr_dev(rect, "rx", rect_rx_value);
    			}

    			if (dirty & /*position*/ 2 && circle0_cx_value !== (circle0_cx_value = /*position*/ ctx[1].x)) {
    				attr_dev(circle0, "cx", circle0_cx_value);
    			}

    			if (dirty & /*position*/ 2 && circle0_cy_value !== (circle0_cy_value = /*position*/ ctx[1].y)) {
    				attr_dev(circle0, "cy", circle0_cy_value);
    			}

    			if (dirty & /*position, scale*/ 6 && circle1_cx_value !== (circle1_cx_value = /*position*/ ctx[1].x + /*scale*/ ctx[2].x)) {
    				attr_dev(circle1, "cx", circle1_cx_value);
    			}

    			if (dirty & /*position*/ 2 && circle1_cy_value !== (circle1_cy_value = /*position*/ ctx[1].y)) {
    				attr_dev(circle1, "cy", circle1_cy_value);
    			}

    			if (dirty & /*position, scale*/ 6 && circle2_cx_value !== (circle2_cx_value = /*position*/ ctx[1].x + /*scale*/ ctx[2].x)) {
    				attr_dev(circle2, "cx", circle2_cx_value);
    			}

    			if (dirty & /*position, scale*/ 6 && circle2_cy_value !== (circle2_cy_value = /*position*/ ctx[1].y + /*scale*/ ctx[2].y)) {
    				attr_dev(circle2, "cy", circle2_cy_value);
    			}

    			if (dirty & /*position*/ 2 && circle3_cx_value !== (circle3_cx_value = /*position*/ ctx[1].x)) {
    				attr_dev(circle3, "cx", circle3_cx_value);
    			}

    			if (dirty & /*position, scale*/ 6 && circle3_cy_value !== (circle3_cy_value = /*position*/ ctx[1].y + /*scale*/ ctx[2].y)) {
    				attr_dev(circle3, "cy", circle3_cy_value);
    			}

    			if (dirty & /*visibility*/ 8) {
    				set_style(div, "--visibility", /*visibility*/ ctx[3]);
    			}
    		},
    		i: noop,
    ...
    function instance$3($$self, $$props, $$invalidate) {
    	...
    	validate_store(canvasCurrentTranslation, "canvasCurrentTranslation");
    	component_subscribe($$self, canvasCurrentTranslation, $$value => $$invalidate(13, $canvasCurrentTranslation = $$value));
    	validate_store(canvasCurrentScale, "canvasCurrentScale");
    	component_subscribe($$self, canvasCurrentScale, $$value => $$invalidate(0, $canvasCurrentScale = $$value));
    	let { $$slots: slots = {}, $$scope } = $$props;
    	...
    	const scalePoints = {
    		TOP_LEFT: {
    			positionMultiplier: positionMultiplier.TOP_LEFT,
    			scaleMultiplier: scaleMultiplier.TOP_LEFT
    		},
    		TOP_RIGHT: {
    			positionMultiplier: positionMultiplier.TOP_RIGHT,
    			scaleMultiplier: scaleMultiplier.TOP_RIGHT
    		},
    		BOTTOM_LEFT: {
    			positionMultiplier: positionMultiplier.BOTTOM_LEFT,
    			scaleMultiplier: scaleMultiplier.BOTTOM_LEFT
    		},
    		BOTTOM_RIGHT: {
    	...
    	function windowMouseMove(e) {
    		if (compareInput(operations.ITEM.MOVE) && scaling && scalePoint != null) {
    			...
    			for (let item of selectedItems) {
    				Vector.divideEach(item.position, initialScale);
    	...
    	function scaleMouseDown(e, point = scalePoints.TOP_LEFT) {
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console_1$2.warn(`<Selection> was created with unknown prop '${key}'`);
    	});

    	const mousedown_handler = e => scaleMouseDown(e, scalePoints.TOP_LEFT);
    	const mousedown_handler_1 = e => scaleMouseDown(e, scalePoints.TOP_RIGHT);
    	const mousedown_handler_2 = e => scaleMouseDown(e, scalePoints.BOTTOM_RIGHT);
    	const mousedown_handler_3 = e => scaleMouseDown(e, scalePoints.BOTTOM_LEFT);
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ("bounds" in $$props) $$invalidate(9, bounds = $$props.bounds);
    		if ("scaling" in $$props) scaling = $$props.scaling;
    		if ("scalePoint" in $$props) scalePoint = $$props.scalePoint;
    		if ("currentCanvasItems" in $$props) $$invalidate(10, currentCanvasItems = $$props.currentCanvasItems);
    		if ("selectedItems" in $$props) $$invalidate(12, selectedItems = $$props.selectedItems);
    	};
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty & /*$canvasItems*/ 2048) {
    			$$invalidate(10, currentCanvasItems = $canvasItems);
    		}

    		if ($$self.$$.dirty & /*currentCanvasItems*/ 1024) {
    			$$invalidate(12, selectedItems = currentCanvasItems.filter(element => element.selected));
    		}

    		if ($$self.$$.dirty & /*selectedItems*/ 4096) {
    		...
    		if ($$self.$$.dirty & /*visible*/ 256) {
    			if (visible) {
    				$$invalidate(3, visibility = "visible");
    			} else {
    				$$invalidate(3, visibility = "hidden");
    			}
    		}

    		if ($$self.$$.dirty & /*visible, selectedItems*/ 4352) {
    			if (visible) {
    				...
    				$$invalidate(9, bounds = { left, right, top, bottom });
    			}
    		}

    		if ($$self.$$.dirty & /*visible, bounds, $canvasCurrentTranslation, $canvasCurrentScale*/ 8961) {
    			if (visible) {
    				$$invalidate(1, position = worldToScreen(bounds.left, bounds.top, $canvasCurrentTranslation.x, $canvasCurrentTranslation.y, $canvasCurrentScale));
    			}
    		}

    		if ($$self.$$.dirty & /*visible, bounds, $canvasCurrentScale*/ 769) {
    			if (visible) {
    				...
    				$$invalidate(2, scale = Vector.multiplyBoth(difference, $canvasCurrentScale));
    			}
    		}
    	};
    ...
    const file$2 = "src\\core\\CanvasItem.svelte";
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "class", div_class_value = "" + (null_to_empty(/*divclass*/ ctx[1]) + " svelte-x87490"));
    			add_location(div, file$2, 102, 0, 3498);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (!current || dirty & /*divclass*/ 2 && div_class_value !== (div_class_value = "" + (null_to_empty(/*divclass*/ ctx[1]) + " svelte-x87490"))) {
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console_1$1.warn(`<CanvasItem> was created with unknown prop '${key}'`);
    	});
    ...
    class CanvasItem extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$2, create_fragment$2, safe_not_equal, { itemId: 0, itemIndex: 8 });
    ...
    const file$1 = "src\\core\\Canvas.svelte";
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file$1, 165, 2, 5611);
    			...
    			add_location(div1, file$1, 171, 2, 5741);
    			attr_dev(div2, "id", "canvas");
    			attr_dev(div2, "class", "svelte-19f4qs0");
    			add_location(div2, file$1, 164, 0, 5531);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
