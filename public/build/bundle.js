...
var app = (function () {
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			svg = svg_element("svg");
    			rect = svg_element("rect");
    			attr_dev(rect, "x", rect_x_value = /*position*/ ctx[0].x);
    			attr_dev(rect, "y", rect_y_value = /*position*/ ctx[0].y);
    			attr_dev(rect, "width", rect_width_value = "" + (/*scale*/ ctx[1].x + "px"));
    			attr_dev(rect, "height", rect_height_value = "" + (/*scale*/ ctx[1].y + "px"));
    			add_location(rect, file$2, 40, 4, 1544);
    			attr_dev(svg, "width", "100000");
    			attr_dev(svg, "height", "100000");
    			add_location(svg, file$2, 39, 2, 1502);
    			attr_dev(div, "id", "selection");
    			set_style(div, "--visibility", /*visibility*/ ctx[2]);
    			attr_dev(div, "class", "svelte-1jrx6ho");
    			add_location(div, file$2, 38, 0, 1443);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*position*/ 1 && rect_x_value !== (rect_x_value = /*position*/ ctx[0].x)) {
    				attr_dev(rect, "x", rect_x_value);
    			}

    			if (dirty & /*position*/ 1 && rect_y_value !== (rect_y_value = /*position*/ ctx[0].y)) {
    				attr_dev(rect, "y", rect_y_value);
    			}

    			if (dirty & /*scale*/ 2 && rect_width_value !== (rect_width_value = "" + (/*scale*/ ctx[1].x + "px"))) {
    				attr_dev(rect, "width", rect_width_value);
    			}

    			if (dirty & /*scale*/ 2 && rect_height_value !== (rect_height_value = "" + (/*scale*/ ctx[1].y + "px"))) {
    				attr_dev(rect, "height", rect_height_value);
    			}
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	let $canvasItems;
    	validate_store(canvasItems, "canvasItems");
    	component_subscribe($$self, canvasItems, $$value => $$invalidate(6, $canvasItems = $$value));
    	let { $$slots: slots = {}, $$scope } = $$props;
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ("currentCanvasItems" in $$props) $$invalidate(5, currentCanvasItems = $$props.currentCanvasItems);
    		if ("selectedItems" in $$props) $$invalidate(7, selectedItems = $$props.selectedItems);
    	};
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty & /*$canvasItems*/ 64) {
    			$$invalidate(5, currentCanvasItems = $canvasItems);
    		}

    		if ($$self.$$.dirty & /*currentCanvasItems*/ 32) {
    			$$invalidate(7, selectedItems = currentCanvasItems.filter(element => element.selected));
    		}

    		if ($$self.$$.dirty & /*selectedItems*/ 128) {
    		...
    		if ($$self.$$.dirty & /*visible*/ 8) {
    			if (visible) {
    				$$invalidate(2, visibility = "visible");
    			} else {
    				$$invalidate(2, visibility = "hidden");
    			}
    		}

    		if ($$self.$$.dirty & /*visible, selectedItems*/ 136) {
    			if (visible) {
    				...
    				$$invalidate(4, bounds = { left, right, top, bottom });
    			}
    		}

    		if ($$self.$$.dirty & /*visible, bounds*/ 24) {
    			if (visible) {
    				$$invalidate(0, position = worldToScreen(bounds.left, bounds.top));
    			}
    		}

    		if ($$self.$$.dirty & /*visible, bounds, position*/ 25) {
    			if (visible) {
    				$$invalidate(1, scale = worldToScreen(Vector.subtractEach({ x: bounds.right, y: bounds.bottom }, position)));
    			}
    		}
    	};
